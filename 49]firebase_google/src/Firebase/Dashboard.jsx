        ...
        {userData ? (
          <div className="bg-gray-800 rounded-lg shadow-md p-6 max-w-md mx-auto">
            ...
            <button
              ...
              className="w-full px-4 py-2 mt-4 bg-red-600 text-white rounded hover:bg-red-700 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-red-400"
            >
              Sign Out
            </button>
          </div>
